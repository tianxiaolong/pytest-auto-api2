...
# 使用新的数据驱动接口获取测试数据
# 注意：需要根据实际情况指定具体的文件名
TestData = get_test_data('Collect', 'collect_update_tool.yaml')
...
if __name__ == '__main__':
    pytest.main(['collect_update_tool.yaml', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
