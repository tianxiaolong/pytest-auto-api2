...
This module provides lark functionality.
"""
            ...
            "content": {
                "post": {
                    "zh_cn": {
                        ...
                        "content": [
                            [
                                {"tag": "a", "text": "测试报告链接1", "href": f"http://{get_host_ip()}:9999/index.html"},
                                {"tag": "text", "text": " | "},
                                {"tag": "a", "text": "测试报告链接2", "href": "http://localhost:9999/index.html"},
                                {"tag": "text", "text": " | "},
                                {"tag": "a", "text": "测试报告链接3", "href": "http://127.0.0.1:9999/index.html"},
                                {
                                    "tag": "at",
                            ...
                            [{"tag": "text", "text": "运行  环境 : "}, {"tag": "text", "text": f"{config.env}"}],
                            [
                                {"tag": "text", "text": "成   功   率 : "},
