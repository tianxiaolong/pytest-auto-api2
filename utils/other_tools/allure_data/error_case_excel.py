...
# -*- coding: utf-8 -*-
"""
Error Case Excel Module

This module provides error case excel functionality.
"""
...
try:
    ...
    print("警告: xlwings 未安装，Excel 报告功能将不可用")
...
class ErrorCaseExcel:
    ...
    def __init__(self):
        if not XLWINGS_AVAILABLE:
            print("错误: xlwings 未安装，无法生成 Excel 报告")
            self.app = None
            self.w_book = None
            self.sheet = None
    ...
    def write_case(self):
        ...
        """
        if not XLWINGS_AVAILABLE:
            print("跳过 Excel 报告生成：xlwings 未安装")
            return
