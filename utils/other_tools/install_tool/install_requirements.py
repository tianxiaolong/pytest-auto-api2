...
This module provides install requirements functionality.
"""
...
class InstallRequirements:
    ...
    def __init__(self):
        self.version_library_comparisons_path = (
            ensure_path_sep("\\utils\\other_tools\\install_tool\\") + "version_library_comparisons.txt"
        )
        self.requirements_path = (
            os.path.dirname(os.path.dirname(os.path.abspath(__file__))) + os.sep + "requirements.txt"
        )
    ...
    def read_requirements(self):
        ...
        with open(self.requirements_path, "w", encoding=self.check_charset(self.requirements_path)) as file:
    ...
    def text_comparison(self):
        ...
        # 程序中如出现不同的文件，则安装
            ...
            with open(
                self.version_library_comparisons_path, "w", encoding=self.check_charset(self.requirements_path)
            ) as file:
